...
def main() -> None:
    ...
    measurement_path = CSV_MEAS if CSV_MEAS.exists() else SYNTHETIC_DATA

    for required_path, description in (
        (measurement_path, "measurement or synthetic example CSV"),
    ...
    v_meas, i_meas = read_measurement_csv(measurement_path)
    ...
    print(f"[INFO] Input data: {measurement_path}")
